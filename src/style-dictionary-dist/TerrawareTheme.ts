...
const TerrawareTheme: ThemeDictionary = {
  palette: {
    ...
    TwClrBgTertiaryHover:
      'linear-gradient(rgb(178 171 147 / 50%), rgb(178 171 147 / 50%)), linear-gradient(#CBC6B7, #CBC6B7)',
    TwClrBrdr: '#333025',
    ...
    TwClrBgDangerHover:
      'linear-gradient(rgb(168 54 47 / 50%), rgb(168 54 47 / 50%)), linear-gradient(#CB4D45, #CB4D45)',
    TwClrBgDangerTertiary: '#FAEEED',
    TwClrBrdrDanger: '#CB4D45',
    TwClrBrdrDangerActive: '#A8362F',
    TwClrBrdrDangerHover:
      'linear-gradient(rgb(168 54 47 / 50%), rgb(168 54 47 / 50%)), linear-gradient(#CB4D45, #CB4D45)',
    ...
    TwClrBgSuccessHover:
      'linear-gradient(rgb(73 102 34 / 50%), rgb(73 102 34 / 50%)), linear-gradient(#5D822B, #5D822B)',
    ...
    TwClrBgWarningHover:
      'linear-gradient(rgb(129 84 36 / 50%), rgb(129 84 36 / 50%)), linear-gradient(#A36A2D, #A36A2D)',
    TwClrBgWarningTertiary: '#F8EFE5',
    TwClrBrdrWarning: '#A36A2D',
    TwClrBrdrWarningActive: '#815424',
    TwClrBrdrWarningHover:
      'linear-gradient(rgb(129 84 36 / 50%), rgb(129 84 36 / 50%)), linear-gradient(#A36A2D, #A36A2D)',
