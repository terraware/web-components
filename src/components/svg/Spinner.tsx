...
const SvgSpinner = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' xmlSpace='preserve' aria-labelledby={titleId} {...props}>
    ...
    <path opacity={0.85} d='M17.3 13.8c-.5 0-1-.3-1.3-.8l-2.5-4.3c-.5-.7-.2-1.6.5-2 .7-.4 1.6-.2 2 .5l2.5 4.3c.4.7.2 1.6-.5 2-.2.2-.5.3-.7.3z' />
    <path opacity={0.05} d='M33.3 41.5c-.5 0-1-.3-1.3-.8l-2.5-4.3c-.4-.7-.2-1.6.5-2 .7-.4 1.6-.2 2 .5l2.5 4.3c.4.7.2 1.6-.5 2-.2.3-.5.3-.7.3z' />
    <path opacity={0.4} d='M8 34.8c-.5 0-1-.3-1.3-.8-.4-.7-.2-1.6.5-2l4.3-2.5c.7-.4 1.6-.2 2 .5.4.7.2 1.6-.5 2l-4.3 2.5c-.2.2-.5.3-.7.3z' />
    <path opacity={0.7} d='M12.3 18.8c-.3 0-.5-.1-.7-.2L7.2 16c-.7-.4-1-1.3-.5-2s1.3-1 2-.5L13 16c.7.4 1 1.3.5 2-.2.5-.7.8-1.2.8z' />
