  ...
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 200 128' aria-labelledby={titleId} {...props}>
    ...
    <g clipPath='url(#blobby-icon-parchment_svg__a)'>
      ...
      <g mask='url(#blobby-icon-parchment_svg__g)'>
        <path fill='url(#blobby-icon-parchment_svg__h)' d='m156 71-30-30-52.5 44.5L105 117l51-46Z' opacity={0.25} />
      </g>
      <path
        fill='#EAF3DC'
        d='M80 47.333c0-4.762 3.904-8.666 8.667-8.666h32v.002c.236 0 .473.009.713.032 3.862.367 6.62 3.768 6.62 7.528V50c0 2.553-2.113 4.667-4.667 4.667h-6v4.346a1.96 1.96 0 0 1 0 .648v8.685a1.96 1.96 0 0 1 0 .649V82c0 4.016-3.34 7.19-7.333 7.214v.12H80.667c-4.763 0-8.667-3.905-8.667-8.667v-1.334c0-2.553 2.113-4.666 4.667-4.666H80v-21.68a1.999 1.999 0 0 1 0-.648v-5.006Z'
      />
      <path
        fill='#2C8658'
        d='M88.667 38.667c-4.763 0-8.667 3.904-8.667 8.666v5.006a1.999 1.999 0 0 0 0 .648v21.68h-3.333c-2.554 0-4.667 2.113-4.667 4.666v1.334c0 4.762 3.904 8.666 8.667 8.666H110v-.12c3.993-.023 7.333-3.197 7.333-7.213V68.995a1.96 1.96 0 0 0 0-.649v-8.685a1.96 1.96 0 0 0 0-.648v-4.346h6c2.554 0 4.667-2.114 4.667-4.667v-3.77c0-3.76-2.758-7.162-6.62-7.53a7.321 7.321 0 0 0-.713-.03v-.003h-32Zm0 4h25.492a7.21 7.21 0 0 0-.826 3.333v11.333h-4.666a2 2 0 1 0 0 4h4.666v5.334H106a2.002 2.002 0 0 0-.774 3.856 2 2 0 0 0 .774.144h7.333V82c0 1.975-1.622 3.513-3.666 3.318-1.686-.16-3-1.736-3-3.547v-2.438c0-2.553-2.114-4.666-4.667-4.666H84v-20h4.667a2 2 0 1 0 0-4H84v-3.334c0-2.6 2.067-4.666 4.667-4.666Zm32.333.015c1.685.16 3 1.736 3 3.547V50c0 .394-.273.667-.667.667h-6V46c0-1.974 1.622-3.513 3.667-3.318ZM76.667 78.667H102c.393 0 .667.273.667.666v2.438c0 1.284.417 2.468.994 3.562H80.667A4.638 4.638 0 0 1 76 80.667v-1.334c0-.393.273-.666.667-.666Z'
      />
    </g>
    <defs>
      ...
      <linearGradient id='blobby-icon-parchment_svg__h' x1={98.5} x2={120.915} y1={67.991} y2={101.421} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#2C8658' />
        <stop offset={1} stopColor='#ACD278' />
      </linearGradient>
