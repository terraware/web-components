...
const SvgUploadCloud = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 201 128' aria-labelledby={titleId} {...props}>
    ...
    />
    <defs>
      <linearGradient id='upload-cloud_svg__a' x1={127.063} x2={75.718} y1={104} y2={4.481} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='upload-cloud_svg__b' x1={127.063} x2={75.718} y1={104} y2={4.481} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='upload-cloud_svg__d' x1={69.346} x2={93.556} y1={42.619} y2={79.204} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='upload-cloud_svg__e' x1={52.5} x2={62.5} y1={75} y2={90} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='upload-cloud_svg__f' x1={116.5} x2={126.5} y1={97} y2={112} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='upload-cloud_svg__g' x1={122.5} x2={132.5} y1={17} y2={32} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
    </defs>
