...
const SvgEdit = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 201 128' aria-labelledby={titleId} {...props}>
    ...
    />
    <defs>
      <linearGradient id='edit_svg__a' x1={127.7} x2={82.492} y1={99.934} y2={-0.629} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='edit_svg__b' x1={127.7} x2={82.492} y1={99.934} y2={-0.629} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='edit_svg__d' x1={74.21} x2={140.326} y1={37.321} y2={93.421} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='edit_svg__e' x1={135.5} x2={145.5} y1={92} y2={107} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='edit_svg__f' x1={76.5} x2={86.5} y1={17} y2={32} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='edit_svg__g' x1={52.5} x2={62.5} y1={68} y2={83} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
    </defs>
