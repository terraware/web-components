  ...
  <svg viewBox='0 0 200 128' xmlns='http://www.w3.org/2000/svg' aria-labelledby={titleId} {...props}>
    ...
    <g clipPath='url(#blobby-icon-leaf_svg__a)'>
      ...
      <path
        ...
        fillOpacity={0.2}
      />
      <path d='M108.999 107.449h-.019c-2.75 0-4.982-3.33-5-7.449-.018 4.109-2.239 7.434-4.98 7.449 2.741.015 4.962 3.34 4.98 7.449.018-4.119 2.25-7.449 5-7.449h.019ZM142.999 20.449h-.019c-2.75 0-4.982-3.33-5-7.449-.018 4.11-2.239 7.434-4.98 7.449 2.741.015 4.962 3.34 4.98 7.449.018-4.119 2.25-7.449 5-7.449h.019ZM66.999 43.449h-.02c-2.75 0-4.98-3.33-4.999-7.449-.018 4.11-2.239 7.434-4.98 7.449 2.741.015 4.962 3.34 4.98 7.449.018-4.119 2.25-7.449 5-7.449h.019Z' />
      <mask
