  ...
  <svg viewBox='0 0 200 128' fill='none' xmlns='http://www.w3.org/2000/svg' aria-labelledby={titleId} {...props}>
    ...
    <g clipPath='url(#blobby-icon-leaf_svg__a)'>
      ...
      <g mask='url(#blobby-icon-leaf_svg__g)'>
        <path opacity={0.25} d='m162.332 85.1-47.037-47.036-37.401 51.988 40.23 40.23L162.332 85.1Z' fill='url(#blobby-icon-leaf_svg__h)' />
      </g>
      <path
    ...
    <defs>
      <linearGradient id='blobby-icon-leaf_svg__b' x1={125.711} y1={104} x2={74.42} y2={4.404} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-leaf_svg__c' x1={99} y1={100} x2={109} y2={115} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-leaf_svg__d' x1={133} y1={13} x2={143} y2={28} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-leaf_svg__e' x1={57} y1={36} x2={67} y2={51} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-leaf_svg__f' x1={125.711} y1={104} x2={74.42} y2={4.404} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-leaf_svg__h' x1={89.948} y1={68.617} x2={133.112} y2={114.805} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
