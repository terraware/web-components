  ...
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 200 128' aria-labelledby={titleId} {...props}>
    ...
    <g clipPath='url(#blobby-icon-happy_svg__a)'>
      ...
      <g mask='url(#blobby-icon-happy_svg__g)'>
        <path fill='url(#blobby-icon-happy_svg__h)' d='M160.321 86.616 119.614 45.91 82.227 83.856l40.229 40.229 37.865-37.469Z' opacity={0.25} />
      </g>
      <path
        fill='#F0F4FF'
    ...
    <defs>
      <linearGradient id='blobby-icon-happy_svg__b' x1={126.563} x2={75.218} y1={104} y2={4.481} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-happy_svg__c' x1={47} x2={57} y1={28} y2={43} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-happy_svg__d' x1={143} x2={153} y1={57} y2={72} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-happy_svg__e' x1={75} x2={85} y1={86} y2={101} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-happy_svg__f' x1={126.563} x2={75.218} y1={104} y2={4.481} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-happy_svg__h' x1={93.765} x2={133.246} y1={72.435} y2={114.68} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
