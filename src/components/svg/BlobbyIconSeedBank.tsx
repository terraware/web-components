  ...
  <svg viewBox='0 0 200 128' fill='none' xmlns='http://www.w3.org/2000/svg' aria-labelledby={titleId} {...props}>
    ...
    <g clipPath='url(#blobby-icon-seed-bank_svg__a)'>
      ...
      <g mask='url(#blobby-icon-seed-bank_svg__g)'>
        <path opacity={0.25} d='m152.2 77.2-28.7-28.7-41.86 37.641L107.5 112l44.7-34.8Z' fill='url(#blobby-icon-seed-bank_svg__h)' />
      </g>
      <path
    ...
    <defs>
      <linearGradient id='blobby-icon-seed-bank_svg__b' x1={125.5} y1={101.5} x2={49.5} y2={23.5} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-seed-bank_svg__c' x1={47} y1={28} x2={57} y2={43} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-seed-bank_svg__d' x1={143} y1={57} x2={153} y2={72} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-seed-bank_svg__e' x1={75} y1={86} x2={85} y2={101} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
      <linearGradient id='blobby-icon-seed-bank_svg__f' x1={125.5} y1={101.5} x2={49.5} y2={23.5} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#007DF2' />
        <stop offset={1} stopColor='#53EA9F' />
      </linearGradient>
      <linearGradient id='blobby-icon-seed-bank_svg__h' x1={94.831} y1={73.5} x2={121.533} y2={102.073} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#308F5F' />
        <stop offset={1} stopColor='#007DF2' />
      </linearGradient>
